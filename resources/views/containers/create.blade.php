    ...
    <div
        ...
        <div class="px-8 py-6 border-b border-slate-700/50 bg-gradient-to-r from-slate-800/80 to-slate-700/80">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-2xl font-black text-white">Buat Peti Kemas Baru</h3>
                    <p class="text-slate-400 mt-1">Tambahkan peti kemas baru ke antrian pemrosesan</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('containers.store') }}" class="p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <!-- Customer Selection -->
                <div class="space-y-2">
                    <label for="customer_id" class="block text-sm font-bold text-slate-300 mb-3">JPT</label>
                    <div class="relative">
                        <select name="customer_id" id="customer_id"
                            ...
                            required>
                            <option value="" class="bg-slate-800 text-slate-300">Pilih JPT</option>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select name="type" id="type"
                            ...
                            required>
                            <option value="20ft" class="bg-slate-800 text-white" {{ old('type', '20ft' )=='20ft'
                                ? 'selected' : '' }}>20ft</option>
                            <option value="40ft" class="bg-slate-800 text-white" {{ old('type')=='40ft' ? 'selected'
                                : '' }}>40ft</option>
                        </select>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                            <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select name="status" id="status"
                            ...
                            required>
                            <option value="pending" class="bg-slate-800 text-white" {{ old('status', 'pending'
                                )=='pending' ? 'selected' : '' }}>Menunggu</option>
                            <option value="in_progress" class="bg-slate-800 text-white" {{ old('status')=='in_progress'
                                ? 'selected' : '' }}>Sedang Diproses</option>
                            <option value="completed" class="bg-slate-800 text-white" {{ old('status')=='completed'
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select name="priority" id="priority"
                            ...
                            required>
                            <option value="Normal" class="bg-slate-800 text-white" {{ old('priority', 'Normal'
                                )=='Normal' ? 'selected' : '' }}>Normal</option>
                            <option value="High" class="bg-slate-800 text-white" {{ old('priority')=='High' ? 'selected'
                                : '' }}>Prioritas Tinggi</option>
                        </select>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                            <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                {{-- Entry Date --}}
                <div class="space-y-2">
                    <label for="entry_date" class="block text-sm font-bold text-slate-300 mb-3">Tanggal Masuk</label>
                    <div class="relative">
                        <input onload="this.value = new Date().toISOString().split('T')[0]" type="date"
                            name="entry_date" id="entry_date" value="{{ old('entry_date') }}"
                            class="w-full px-4 py-4 bg-gradient-to-r from-slate-700/50 to-slate-600/50 border border-slate-600/50 rounded-2xl shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all duration-300 text-white placeholder-slate-400 backdrop-blur-sm @error('entry_date') border-red-400/50 focus:ring-red-500/50 focus:border-red-400/50 @enderror"
                    ...
                    <div
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400">Pilih tingkat prioritas yang sesuai dengan urgensi dan
