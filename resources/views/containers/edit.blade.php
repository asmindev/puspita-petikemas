...
<div class="w-full">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form method="POST" action="{{ route('containers.update', $container) }}" class="p-4">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        <select name="customer_id" id="customer_id"
                            ...
                            <option value="{{ $customer->id }}" {{ old('customer_id', $container->
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        <select name="type" id="type"
                            ...
                            <option value="40ft" {{ old('type', $container->type) == '40ft' ? 'selected' : '' }}>40ft
                            </option>
                        </select>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        <select name="status" id="status"
                            ...
                            <option value="in_progress" {{ old('status', $container->status)=='in_progress' ? 'selected'
                                : '' }}>Sedang Diproses</option>
                            <option value="completed" {{ old('status', $container->status)=='completed' ? 'selected' :
                                '' }}>Selesai</option>
                        </select>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        <select name="priority" id="priority"
                            ...
                            <option value="High" {{ old('priority', $container->priority)=='High' ? 'selected' : ''
            ...
            <div class="mt-6 pt-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('containers.index') }}"
                            class="px-4 py-2 bg-gray-100 hover:bg-gray-200 border border-gray-300 text-gray-700 hover:text-gray-800 font-medium rounded-xl transition-all duration-200 text-sm">
