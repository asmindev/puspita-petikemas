...
<div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm mb-4">
    <form method="GET" action="{{ route('containers.index') }}" class="space-y-4 lg:space-y-0">
        <div class="flex flex-col lg:flex-row lg:items-end lg:space-x-4 space-y-4 lg:space-y-0">
            <!-- Search Input -->
            <div class="flex-1">
                <label for="search" class="block text-sm font-medium text-gray-700 mb-2">Cari Peti Kemas</label>
                <div class="relative">
            ...
            <table class="w-full divide-y divide-slate-700/50">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider w-1/12">
                            Type
                        </th>
                        <th class="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider w-1/6">
                            Isi Container
                        ...
                        <th
                            class="px-4 py-4 text-right text-xs font-bold text-gray-700 uppercase tracking-wider w-1/12">
                            Aksi
                        </th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-all duration-300 group">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap w-1/6">
                            <div class="text-sm font-medium text-gray-900 truncate">{{ $container->customer->name ??
                                'N/A' }}
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-4 w-1/6">
                            <div class="text-sm text-gray-700">
                                ...
                                @else
                                <span class="text-gray-500 text-xs">Kosong</span>
                                @endif
                            </div>
                        </td>
