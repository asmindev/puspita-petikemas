...
<div class="w-full mx-auto">
    ...
    <div class="mb-8">
        <a href="{{ route('customers.index') }}"
            class="group inline-flex items-center px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 hover:text-blue-600 rounded-2xl border border-gray-300 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
    ...
    <div class="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <form method="POST" action="{{ route('customers.store') }}" class="p-8">
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                            class="w-full px-6 py-4 bg-white border-2 border-gray-300 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-blue-600/20 focus:border-blue-600 transition-all duration-300 text-lg font-medium @error('name') border-red-500 focus:ring-red-500/20 focus:border-red-500 @enderror"
                            placeholder="Masukkan nama lengkap pelanggan" required>
                        <div
                            class="absolute inset-0 rounded-2xl bg-blue-600/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        </div>
                        @if(!$errors->has('name'))
            ...
            <div class="flex items-center justify-end space-x-4 pt-8 border-t border-gray-200 mt-8">
                ...
                <button type="submit"
                    class="group relative px-8 py-4 text-lg font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-blue-600/25">
