...
<div class="w-full">
    ...
    <div class="mb-8">
        <a href="{{ route('customers.index') }}"
            class="group inline-flex items-center bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 hover:text-primary py-3 px-6 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl">
    ...
    <div class="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <div class="px-8 py-6 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center">
                <div class="p-3 bg-primary rounded-2xl border border-blue-200">
        ...
        <form method="POST" action="{{ route('customers.update', $customer) }}" class="p-8">
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="text" name="name" id="name" value="{{ old('name', $customer->name) }}"
                            class="w-full px-4 py-4 bg-white border border-gray-300 rounded-2xl shadow-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-300 text-gray-900 placeholder-gray-400 @error('name') border-red-500 focus:ring-red-500/50 focus:border-red-500 @enderror"
                ...
                <div class="space-y-2 mt-6">
                    <label for="pin" class="block text-sm font-bold text-gray-700 mb-3">PIN Keamanan</label>
                    <div class="relative">
                        <input type="text" name="pin" id="pin" value="{{ old('pin', $customer->pin) }}"
                            class="w-full px-4 py-4 bg-white border border-gray-300 rounded-2xl shadow-lg focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all duration-300 text-gray-900 placeholder-gray-400 @error('pin') border-red-500 focus:ring-red-500/50 focus:border-red-500 @enderror"
                    ...
                    <div class="mt-2 text-xs text-gray-600 flex items-center">
                        ...
                        PIN ini digunakan untuk verifikasi pelanggan saat melacak peti kemas
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="text-center">
                            <div class="bg-white border border-blue-200 rounded-xl p-4">
                                <p class="text-sm font-medium text-primary mb-2">Jumlah Peti Kemas</p>
                                <p class="text-3xl font-black text-gray-900">{{ $customer->container_count }}</p>
                                <div class="flex items-center justify-center mt-2">
                                    <svg class="w-4 h-4 text-primary mr-1" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-12 pt-8 border-t border-slate-700/50">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button type="submit"
                            class="group relative bg-gradient-to-r from-primary via-blue-700 to-indigo-700 hover:from-blue-700 hover:via-blue-800 hover:to-indigo-800 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-blue-500/25 transform hover:-translate-y-1 hover:scale-105">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-primary to-indigo-600 rounded-2xl blur opacity-50 group-hover:opacity-75 transition-opacity">
                            </div>
